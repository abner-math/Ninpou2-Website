...
export function DeleteLadderDialog({ ladderName, open, onOpenChanged, onLadderDeleted }: DeleteLadderDialogProps) {
    ...
    return (
        ...
        >
            ...
            <DialogActions>
                ...
                <Button type="submit" color="warning">Delete</Button>
            </DialogActions>
        </Dialog>
    );
}
