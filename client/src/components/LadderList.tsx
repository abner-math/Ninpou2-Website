...
export function LadderList({ ladders, onLaddersChange, selectedLadderName, onSelectedLadderNameChange, ladderSearchQuery, onLadderSearch }: LadderListProps) {
    ...
    return (
        <Fragment>
            ...
            <DeleteLadderDialog
                ...
                onLadderDeleted={() => {
                    onLaddersChange({ ...ladders, private: ladders.private.filter(ladder => ladder.name !== deletedLadderName) });
                }}
            />
            <Box>
